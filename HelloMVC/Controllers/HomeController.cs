...
namespace HelloMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            Customer customer = customers.FirstOrDefault(customers => customers.Id == id);
            if (customer == null)
            {
                return HttpNotFound();
            }
    ...
    public ActionResult AddCustomer(Customer customer)
        ...
        {
            var customerToEdit = customers.FirstOrDefault(customers => customers.Id == Id);
            if (customer == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ActionName("DeleteCustomer")] //even if our classname is CornfirmDeleteCustomer expect a deletecustomer method
